...
#define DL_LINKED_LIST_DATA(element) ((dl_ptr)&((struct dl_linked_list_node *)element)[1])
    ...
    dl_api dl_ptr dl_linked_list_get(const dl_linked_list *list, struct dl_linked_list_node *position, dl_ptr out);
    dl_api dl_ptr dl_linked_list_ref(const struct dl_linked_list_node *position);
    dl_api dl_ptr dl_linked_list_set(dl_linked_list *list, struct dl_linked_list_node *position, dl_ptr value);
    dl_api struct dl_linked_list_node *dl_linked_list_index(const dl_linked_list *list, dl_natural position);

    dl_api struct dl_linked_list_node *dl_linked_list_insert(dl_linked_list *list, struct dl_linked_list_node *position, dl_ptr value);
    dl_api dl_ptr dl_linked_list_remove(dl_linked_list *list, struct dl_linked_list_node *position, dl_ptr out);
...
dl_integer _default_compare_8(dl_ptr data, dl_ptr left, dl_ptr right) {
    return (dl_integer)(*(unsigned char *)left - *(unsigned char *)right);
}

dl_integer _default_compare_16(dl_ptr data, dl_ptr left, dl_ptr right) {
    return (dl_integer)(*(unsigned int *)left - *(unsigned int *)right);
}

dl_integer _default_compare_32(dl_ptr data, dl_ptr left, dl_ptr right) {
    return (dl_integer)(*(unsigned long int *)left - *(unsigned long int *)right);
}

dl_integer _default_compare_64(dl_ptr data, dl_ptr left, dl_ptr right) {
#if DL_IS_ATLEAST_C99
...
dl_integer _default_compare_any(dl_ptr data, dl_ptr left, dl_ptr right) {
    return 0;
}
...
dl_integer _collection_sorted_list_predicate_func(dl_ptr data, dl_ptr value) {
